...
setup(
    ...
    description='Calibrate lane parameters for a aelf-driving car Webots + ROS2 package',
    license='Apache License 2.0',
    tests_require=['pytest'],

    entry_points={
      'console_scripts': [
         'lane_detector_canny_hough = get_lane_params.lane_detector_canny_hough:main',
      ],
    },
)
