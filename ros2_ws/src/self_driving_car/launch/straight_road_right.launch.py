...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'max_speed',
            default_value='20',
            description='Maximum speed for the car'
        ),
        DeclareLaunchArgument(
            'k_following',
            default_value='10',
            description='Following gain'
        ),
        DeclareLaunchArgument(
            'dist_to_car',
            default_value='20',
            description='Distance to car for following'
        ),
        DeclareLaunchArgument(
            'goal_dist',
            default_value='200',
