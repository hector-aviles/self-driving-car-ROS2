...
def generate_launch_description():
    ...
    world_path = os.path.join(package_dir, 'worlds', 'world_04_ros2.wbt')
    ...
    return LaunchDescription([
        ...
        Node(package='self_driving_car', executable='goal_reached', output='screen',
             parameters=[{'goal_dist': LaunchConfiguration('goal_dist')}]),
